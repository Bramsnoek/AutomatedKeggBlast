...
class BlastController(object):
    def __init__(self, *organisms, pathway_id = PENTOSE_AND_GLUCURONATE_INTERCONVERSIONS):
        ...
        for entry in self.__pathway.get_entries():
            print(entry.get_fasta(True))

    def blast(self, blast_type: BlastType, database = "nr", evalue = 0.01, output_dir = "Data/Output"):
        os.makedirs(output_dir, exist_ok=True)
        with open("{}/{}_results.csv".format(output_dir, blast_type.name), "a") as result_file:
            result_file.write("query;title;length;score;bits;expect;num_alignments;identities;positives;gaps;strand;frame;query;query_start;match;subject;subject_start;align_length\n")
                            ...
                            for blast_record in blast_records:
                                for alignment in blast_record.alignments:
                                    for hsp in alignment.hsps:
                                        result_file.write("{};{};{};{};{};{};{};{};{};{};{};{};{};{};{};{};{};{}\n"
                                        .format(blast_record.query, alignment.title, alignment.length, hsp.score, hsp.bits, hsp.expect, hsp.num_alignments,
